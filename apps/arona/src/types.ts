...
import type { S3Service, OneBotService, RedisService, WormfaceService } from "./services/index.js";
import { NodeContext } from "@effect/platform-node";
import { MlService } from "./services/ml.js";

export type Services = RedisService | S3Service | OneBotService | WormfaceService | MlService | NodeContext.NodeContext;
